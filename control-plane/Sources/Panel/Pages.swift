            ...
            : vpsList.map { v in
                ...
                <div class="srvcard" data-vps="\(esc(v.name))" onclick="location.href='/vps/\(esc(v.name))'">
                  ...
                  <div class="acts">
                    ...
                    <form method="post" action="/destroy" class="ajax danger-form" data-confirm="Destroy \(esc(v.display))? This permanently deletes the VM and its disk." onclick="event.stopPropagation()">
